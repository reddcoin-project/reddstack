...
DEBUG = True if os.environ.get("BLOCKSTACK_DEBUG", None) == "1" else False
...
""" Bitcoin configs
"""
DEFAULT_BITCOIND_SERVER = 'localhost'
DEFAULT_BITCOIND_PORT = 45443
DEFAULT_BITCOIND_PORT_TESTNET = 55443
DEFAULT_BITCOIND_USERNAME = 'reddcoinrpc'
DEFAULT_BITCOIND_PASSWD = ''

""" block indexing configs
"""
REINDEX_FREQUENCY = 30 # 300 seconds

FIRST_BLOCK_MAINNET = 2000000
FIRST_BLOCK_MAINNET_TESTSET = 2000000
# FIRST_BLOCK_TESTNET = 343883
FIRST_BLOCK_TESTNET = 2530000
...
DEFAULT_DUST_FEE = 100000
DEFAULT_RELAY_FEE = 1000000
...
NAMESPACE_1_CHAR_COST = 2500000 * SATOSHIS_PER_BTC        # ~$3000.00 @ 19 November 2017 (BTC price $7800USD)
NAMESPACE_23_CHAR_COST = 250000 * SATOSHIS_PER_BTC        # ~ $300.00
NAMESPACE_4567_CHAR_COST = 25000 * SATOSHIS_PER_BTC       # ~  $30.00
NAMESPACE_8UP_CHAR_COST = 2500 * SATOSHIS_PER_BTC         # ~   $3.00
...
BLOCKSTORE_BURN_ADDRESS = virtualchain.hex_hash160_to_address( BLOCKSTORE_BURN_PUBKEY_HASH )   # "1111111111111111111114oLvT2"
