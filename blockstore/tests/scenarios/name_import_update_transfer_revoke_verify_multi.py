...
def check( state_engine ):
    ...
    for i in xrange(0, len(names)):
        ...
        # not preordered
        preorder = state_engine.get_name_preorder( name, pyreddcoin.make_pay_to_address_script(name_preorder_wallet.addr), name_register_wallet.addr )
        ...
        if name_rec['address'] != name_transfer_wallet.addr or name_rec['sender'] != pyreddcoin.make_pay_to_address_script(name_transfer_wallet.addr):
